...
<head>
<meta charset="UTF-8">
<title>Check Patient History</title>
<link
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	...
	<form action="/ZOHO_HOSPITAL/historyInpput"></br></br>
	
	Enter Patient Mobile No: <input type="number" name="historyName"/></br></br>
	Submit To Generate History <button type="submit" name="historyBUTTON" value="historyBUTTON">Submit Details</button>
