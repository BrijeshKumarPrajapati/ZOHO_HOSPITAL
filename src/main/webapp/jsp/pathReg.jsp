...
<head>
<meta charset="UTF-8">
<title>Pathologist Registration</title>
<link
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	...
	<h5>Register Pathologist Here</h5>
	
	<form action="/ZOHO_HOSPITAL/Reg" method="post">
Full Name <input type="text" name ="Name"/></br></br>
Email <input type="text" name="Email"/></b></br></br>
Password <input type="text" name="Pass"/></br></br>
Role <input type="text" name="Role" value="path"/></br></br>
Mobile <input type="number" name="Mobile"/></br></br>
Specialization <input type="text" name="Specialization" value="pathologist"/></br></br>
