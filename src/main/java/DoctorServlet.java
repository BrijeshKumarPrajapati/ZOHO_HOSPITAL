...
public class DoctorServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (request.getParameter("userDoc") != null && request.getParameter("docPass") != null
					&& obj1.valid(mobile).getPassword().equals(password) && obj1.valid(mobile).getMobile() == mobile) {
